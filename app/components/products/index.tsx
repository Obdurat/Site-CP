  ...
  const cards = useMemo(
    () =>
      productsContent.consigned.cards.map((card) => (
        <div className="flex gap-4 bg-background rounded-3xl overflow-hidden">
  ...
  return (
    ...
    >
      {productsContent.productCards.map((card, i) => (
        <div
          className={cn(
            'flex gap-4 bg-background rounded-3xl overflow-hidden bg-blue-950 flex-col sm:flex-row',
            i % 3 === 0 && 'lg:col-span-2'
          )}
        >
          <div className="flex gap-4 flex-col w-full lg:max-w-[60%] p-8 sm:pr-0">
