  ...
  return (
    <section className="flex gap-4 justify-between items-start bg-[#FFFFFF0D] rounded-[2rem]  lg:h-[400px] max-w-[820px] w-full p-8 md:p-16 flex-col md:flex-row h-hull">
      <div className="flex flex-col gap-4">
        <h3 className="font-bold text-cyan-500 text-lg">Atendimento</h3>
      ...
      <div className="flex flex-col gap-16">
        <div className="flex flex-col gap-4">
          <h3 className="font-bold text-cyan-500 text-lg">Siga a Bevi</h3>
        ...
        <div className="flex flex-col gap-4">
          <h3 className="font-bold text-cyan-500 text-lg whitespace">
            Baixe o APP
          </h3>
